...
LOGO_EMPRESA_CURTI = os.path.join(BASE_DIR, 'logo_curti.JPG')
LOGO_EMPRESA_LBC = os.path.join(BASE_DIR, 'logo_lbc.JPG')
LOGO_EMPRESA_COMER = os.path.join(BASE_DIR, 'logo_comer.JPG')